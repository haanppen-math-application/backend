package com.hpmath.hpmathcoreapi.board.config;
...
public class EntityFieldMappedPageRequestMethodArgumentResolver extends PageableHandlerMethodArgumentResolver {
    @Override
