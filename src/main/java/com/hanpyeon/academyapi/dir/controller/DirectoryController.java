...
public class DirectoryController {
    ...
    public ResponseEntity<?> createDirectory(
        ...
        final CreateDirectoryDto createDirectoryDto = new CreateDirectoryDto(createDirectoryRequest.directoryName(), createDirectoryRequest.directoryPath(), memberPrincipal.memberId());
        directoryService.createNewDirectory(createDirectoryDto);
