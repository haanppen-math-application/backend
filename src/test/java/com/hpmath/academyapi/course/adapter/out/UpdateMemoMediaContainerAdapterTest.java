...
class UpdateMemoMediaContainerAdapterTest {
    ...
    void testSequenceUpdate() {
        ...
        memoMediaRepository.saveAll(List.of(
                com.hpmath.academyapi.course.entity.MemoMedia.of(null, media1, 1),
                com.hpmath.academyapi.course.entity.MemoMedia.of(null, media2, 2),
                com.hpmath.academyapi.course.entity.MemoMedia.of(null, media3, 3))
        );
